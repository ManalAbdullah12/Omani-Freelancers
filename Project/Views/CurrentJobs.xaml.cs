...
namespace Project.Views
{
	...
	public partial class CurrentJobs : ContentPage
    {
        ...
        public CurrentJobs(RegUserTable userData)
        {
            InitializeComponent();
            _userData = userData;
        ...
        protected async override void OnAppearing()
        {
            ...
            var posts = await userRepository.GetAcceptedFreelancerJobs(_userData.Id);
            Items.Clear();
        ...
        private async void TapGestureRecognizer_Tapped(object sender, EventArgs e)
        {
            ...
            if (frame != null)
            {
                ...
                {
                    await Navigation.PushAsync(new FreelancerCurrentJobDetails(selectedItem));
