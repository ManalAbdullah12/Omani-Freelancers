...
namespace Project.Views
{
	...
	public partial class ClientJobHistory : ContentPage
	{
        ...
        public ClientJobHistory(RegUserTable userData)
        {
            InitializeComponent();
            _userData = userData;
        ...
        protected async override void OnAppearing()
        {
            ...
            var posts = await userRepository.GetClientJobs(_userData.Id);
            Items.Clear();
        ...
        private async void TapGestureRecognizer_Tapped(object sender, EventArgs e)
        {
            ...
            if (frame != null)
            {
                ...
                {
                    await Navigation.PushAsync(new ClientJobDetails(selectedItem));
